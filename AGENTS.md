...
Project rules for any coding agent working in this repository (Claude Code,
Codex, and others). Provider-specific overlays live in `CLAUDE.md` / `CODEX.md`
and sit below this file.
